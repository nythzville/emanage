        ...
        <div id="wrapper">
            <div id="login" class="animate form">
                ...
                <section class="login_content">
                    {!! Form::open( array('url' => 'auth/login', 'class'=>'form-signin', 'id'=>'form-login', 'method'=>'post') ) !!}
                        <h1>Login Form</h1>
                        <div>
            ...
            <div id="register" class="animate form">
                <section class="login_content">
                    {!! Form::open( array('url' => 'auth/register', 'class'=>'form-register', 'id'=>'form-register', 'method'=>'post') ) !!}
