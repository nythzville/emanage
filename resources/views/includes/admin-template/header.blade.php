...
<head>
    ...
    @if( $what == 'employee_attendance')
    <link href="{{ url() }}/css/calendar/fullcalendar.css" rel="stylesheet">
    <link href="{{ url() }}/css/calendar/fullcalendar.print.css" rel="stylesheet" media="print">
    @endif
    <!--[if lt IE 9]>
