...
@section('content')
    ...
    <section class="content">
        <div class="col-sm-12">
            ...
            <a href="/event/{{$event_id}}/products" class="btn btn-primary pull-right"><i class="fa fa-eye"></i> View Event Products</a>
                ...
                <div class="box-body no-padding">
                  <table class="table table-bordered domains-list">
                    ...
                    @foreach( $events as $event )
                        <tr>
                            <th width="15%">Event Start Date</th><td>{{ date('M d Y - H:i:s', strtotime($event->event_date_start) ) }}</td>
                        </tr>
                        <tr>
                            <th width="15%">Event End Date</th><td>{{ date('M d Y - H:i:s', strtotime($event->event_date_end) ) }}</td>
                        </tr>
                        <tr>
